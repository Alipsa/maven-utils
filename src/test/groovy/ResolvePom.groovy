...
def projectInfo(String localRepoUrl, File pomFile){
...
//File pomFile = Paths.get(this.getClass().getResource("/pom/transientPom.xml").toURI()).toFile();
File pomFile = new File(inout.projectDir(), "src/test/resources/pom/transientPom.xml")
println projectInfo("/home/per/.m2/repository", pomFile);
